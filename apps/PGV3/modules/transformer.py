...
from apps.main.modules.embedder import LabelEmbedder, TimestepEmbedder
...
class PGV3(nn.Module):
    ...
    def __init__(self, args: ModelArgs):
        ...
        self.time_proj = TimestepEmbedder(
    ...
    def forward(
        ...
        noised_x, t, target = self.scheduler.sample_noised_input(vae_latent)

        vae_embs, H_, W_, freqs_cis_img = self.patchify_and_embed(noised_x)
        # [B, H/16 * W/16, D]
