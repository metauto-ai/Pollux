...
print(cosmos_dv_vae._enc_model.quantizer.dtype)
print(cosmos_dv_vae._dec_model.inv_quant.quantizer.dtype)
...
# print("==============================\n\n\n")
submodule = getattr(cosmos_dv_vae._enc_model.encoder.down, "0")
print(submodule)
submodule = getattr(cosmos_dv_vae._enc_model.encoder.down, "1")
print(submodule)
submodule = getattr(cosmos_dv_vae._enc_model.encoder.down, "2")
print(submodule)
print(cosmos_dv_vae._enc_model.encoder.mid.block_1)
print(cosmos_dv_vae._enc_model.encoder.mid.attn_1)
print(cosmos_dv_vae._enc_model.encoder.mid.block_2)
