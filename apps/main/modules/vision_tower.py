...
class VisionTower(nn.Module):
    def __init__(
        ...
        # pixel_mean: Optional[List[float]] = None,
        # pixel_std: Optional[List[float]] = None,
        args: VisionTowerArgs,
        **kwargs,
    ):
        super().__init__()

        self.model_name = args.model_name
        self.select_feature = args.select_feature
        self.select_layer = args.select_layer
        self.select_layers = kwargs.get("select_layers", None)
        self.pixel_mean = args.pixel_mean
        self.pixel_std = args.pixel_std
        self.pre_trained_path = args.pre_trained_path
    ...
    def init_weights(self, pre_trained_path=None):
        try:
            if pre_trained_path:
            ...
            try:
                ...
                print(f"SigLIP-ViT downloaded and saved at {save_path}.")
                ...
                print(f"Failed to download and load the pre-trained model. Error: {e}")
                raise RuntimeError("Unable to load or download the model checkpoint.")
