...
class HiDream_Edit():
    def __init__(self,):
        ...
        tokenizer_4 = PreTrainedTokenizerFast.from_pretrained("/mnt/pollux/checkpoints/Llama-3.1-8B")
        text_encoder_4 = LlamaForCausalLM.from_pretrained(
            "/mnt/pollux/checkpoints/Llama-3.1-8B",
            output_hidden_states=True,
            output_attentions=True,
            torch_dtype=torch.bfloat16,
        )
        ...
        self.pipe = HiDreamImageEditingPipeline.from_pretrained(
            "/mnt/pollux/checkpoints/HiDream-E1-Full",
            tokenizer_4=tokenizer_4,
            text_encoder_4=text_encoder_4,
            torch_dtype=torch.bfloat16,
        ).to("cuda", torch.bfloat16)

    def generate(self, instruct, image_path, num_steps=28, seed=3, cfg_guidance=4.0):
        ...
        image = self.pipe(
            ...
            image = input_image,
            guidance_scale=5.0,
            image_guidance_scale=cfg_guidance,
