...
#     --db=world_model \
#     --collection=datacompdr-part-04-of-05-verified \
#     --out=/mnt/pollux/mongo_db_cache/datacompdr-part-04-of-05-verified.json \
#     --query='{"aesthetic_score":{"$gt":5.5}}' --jsonArray
...
# --file=/mnt/pollux/mongo_db_cache/datacompdr-part-01-of-05-verified_processed.json --jsonArray
import json
import requests
...
file_path = "/mnt/pollux/mongo_db_cache/datacompdr-part-01-of-05-verified.json"
...
def update_doc(doc):
    ...
    try:
        ...
        doc_return["source"] = "datacompdr-part-01-of-05-verified"
        return doc_return
...
with open(
    "/mnt/pollux/mongo_db_cache/datacompdr-part-01-of-05-verified_processed.json",
    "w",
    encoding="utf-8",
) as f:
