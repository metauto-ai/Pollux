...
# --db=world_model \
# --collection=sky_pixel_image \
# --out=/mnt/pollux/mongo_db_cache/sky_pixel_image.json --jsonArray
...
# --file=/mnt/pollux/mongo_db_cache/sky_pixel_image_processed.json --jsonArray
...
file_path = "/mnt/pollux/mongo_db_cache/sky_pixel_image.json"
...
def update_doc(doc):
    ...
    try:
        ...
        doc_return["source"] = "sky_pixel_image"
        return doc_return
...
processed_results = [res for res in processed_results if res is not None]
with open(
    "/mnt/pollux/mongo_db_cache/sky_pixel_image_processed.json", "w", encoding="utf-8"
) as f:
