...
# --db=world_model \
# --collection=leonardo \
# --out=/mnt/pollux/mongo_db_cache/leonardo.json --jsonArray
...
# --file=/mnt/pollux/mongo_db_cache/leonardo_processed.json --jsonArray
...
file_path = "/mnt/pollux/mongo_db_cache/leonardo.json"
...
processed_results = [res for res in processed_results if res is not None]
with open(
    "/mnt/pollux/mongo_db_cache/leonardo_processed.json",
    "w",
    encoding="utf-8",
) as f:
